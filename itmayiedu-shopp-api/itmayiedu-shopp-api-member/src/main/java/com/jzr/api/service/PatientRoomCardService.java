...
import com.jzr.entity.RommCardManage.RoomCardEntity;
import org.springframework.web.bind.annotation.RequestMapping;

@Api(name = "病区门卡管理", order = 5)
@RequestMapping("/patintroomcard")
public interface PatientRoomCardService {


    @ApiAction(name = "添加病区诊室门卡", mapping = "patintroomcard/add", method = Method.GET)
    // 请求参数
    ...
    @ApiAction(name = "删除病区诊室门卡", mapping = "patintroomcard/delete", method = Method.GET)
    // 请求参数
    @ApiReqParams(type = ParamType.JSON, value = {
    ...
    @ApiAction(name = "查找单个病区诊室门卡", mapping = "patintroomcard/find", method = Method.GET)
    // 请求参数
    @ApiReqParams(type = ParamType.JSON, value = {
    ...
    @ApiAction(name = "更新单个病区诊室门卡", mapping = "patintroomcard/update", method = Method.GET)
    // 请求参数
    @ApiReqParams(type = ParamType.JSON, value = {
